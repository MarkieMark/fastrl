...
public:
    virtual void observeEnvironmentActionInitiation(State *observation, Action *action) { throw runtime_error("Not Implemented"); }
    virtual void observeEnvironmentInteraction(EnvironmentOutcome *eo) { throw runtime_error("Not Implemented"); }
    virtual void observeEnvironmentReset(Environment * resetEnvironment) { throw runtime_error("Not Implemented"); }
};
